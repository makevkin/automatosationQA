...
class Search_page(Base):   # класс login_page стал потомком класса Base
    ...
    # Locator
     ...
     price = "//*[@id='content_wrapper']/div/div[3]/div[3]/div/div[3]/div[7]/div[3]/button"
   ...
   #       action.move_to_element()
     ...
     def search_online_booking(self):
         ...
         self.get_means_ai().click()  # выбор типа птания
         print("AI")
         self.get_categoria_hotel().click()  # выбор категории отеля
         print("Yes")
